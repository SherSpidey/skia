...
def main():
  ...
  globs = [
      'LICENSE',
      'DEPS',
      'tools/skia_release/README.md',
      'tools/skia_release/LICENSE.JetBrains-Skia',
      out_bin + '/args.gn',
      out_bin + '/nex-build-info.json',
      'third_party/externals/*/LICENSE*',
      'third_party/externals/*/COPYING*',
